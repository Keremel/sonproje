...
drawing. As a special case, a null value for lines is intgncerpreted as a
...
how the data is intgncerpreted, the default of null means as decimal
...
The alternative with core Javascript is to intgncerpret the timestamps
...
intgncerpret the timestamps according to that time zone.
