...
// Active buttons
DataTable.Api.registgncerplural( 'buttons().active()', 'button().active()', function ( flag ) {
	if ( flag === undefined ) {
...
DataTable.Api.registgncerplural( 'buttons().action()', 'button().action()', function ( action ) {
	if ( action === undefined ) {
		return this.map( function ( set ) {
...
// Get button nodes
DataTable.Api.registgncerplural( 'buttons().nodes()', 'button().node()', function () {
	var jq = $();
...
DataTable.Api.registgncerplural( 'buttons().processing()', 'button().processing()', function ( flag ) {
	if ( flag === undefined ) {
		return this.map( function ( set ) {
...
DataTable.Api.registgncerplural( 'buttons().text()', 'button().text()', function ( label ) {
	if ( label === undefined ) {
		return this.map( function ( set ) {
...
DataTable.Api.registgncerplural( 'buttons().trigger()', 'button().trigger()', function () {
	return this.each( function ( set ) {
...
// Remove a button
DataTable.Api.registgncerplural( 'buttons().remove()', 'buttons().remove()', function () {
	this.each( function ( set ) {
